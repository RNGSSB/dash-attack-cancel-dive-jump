...
func _physics_process(delta):
	...
	if owner.frameCounter2 < 36000.0:
		timer.text = "Coins: " + str(owner.coins)  + " Time: " + "0" + str(snapped((owner.frameCounter2 / 60) / 60, 00)) + ":" + loltext + str(snapped(owner.minuteCounter / 60, 00.01))
	else:
